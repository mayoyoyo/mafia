...
- section: Day Actions
- size: 390 x 844
- position: x 9630, y 6926

## Layout

- FRAME "Narrator prompt"  390x844  radius=16
  fill: #000000
  - FRAME "Container"  358x616  layout=VERTICAL  gap=32
    ...
    - INSTANCE "Membership Card"  357x222  layout=VERTICAL  gap=10  pad=93/166/93/166  radius=16  instance of `77:527` "Role=Default" of set "Membership Card"
      ...
      - FRAME "Frame 1"  28x28
        ...
        - VECTOR "Rectangle 2"  28x28
          ...
          fill: #000000 @ 60%
          stroke: #FFFFFF 2px
    - TEXT "jenny did not see the morning 💀"  358x20
      text: "jenny did not see the morning 💀"
...
| --- | --- | --- | --- |
| `I332:4899;287:3467;185:1610` | House | ON_CLICK | `185:1614` |
| `I332:4899;287:3467;185:1610` | House | transitionNodeID | `185:1614` |
| `I332:4899;325:1579` | tab-hotspot-players | ON_CLICK | `287:3435` |
| `I332:4899;325:1579` | tab-hotspot-players | transitionNodeID | `287:3435` |

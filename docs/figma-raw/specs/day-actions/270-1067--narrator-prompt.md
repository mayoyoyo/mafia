...
- section: Day Actions
- size: 390 x 844
- position: x 8980, y 7979

## Layout

- FRAME "Narrator prompt"  390x844  radius=16
  fill: #000000
  - FRAME "Container"  358x656  layout=VERTICAL  gap=32
    ...
    - INSTANCE "Membership Card"  357x222  layout=VERTICAL  gap=10  pad=93/166/93/166  radius=16  instance of `77:527` "Role=Default" of set "Membership Card"
      ...
      - FRAME "Frame 1"  28x28
        ...
        - VECTOR "Rectangle 2"  28x28
          ...
          fill: #000000 @ 60%
          stroke: #FFFFFF 2px
    - TEXT "Someone was meant to die last night. A hand intervened in the dark, and they didn't. No name was left."  358x60
      text: "Someone was meant to die last night. A hand intervened in the dark, and they didn't. No name was left."
      font: Grandstander / Grandstander-Italic 18px w400 lh 19.8px
      fill: #FFFFFF
...
| --- | --- | --- | --- |
| `I332:4865;287:3467;185:1610` | House | ON_CLICK | `185:1614` |
| `I332:4865;287:3467;185:1610` | House | transitionNodeID | `185:1614` |
| `I332:4865;325:1579` | tab-hotspot-players | ON_CLICK | `287:3435` |
| `I332:4865;325:1579` | tab-hotspot-players | transitionNodeID | `287:3435` |

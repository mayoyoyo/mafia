...
- section: Day Actions
- size: 390 x 844
- position: x 8330, y 5873

## Layout

- FRAME "Revealed as Mafia"  390x844  radius=16
  fill: #000000
    ...
    - FRAME "Players"  358x70  layout=VERTICAL  gap=10  pad=0/16/0/16  radius=16
      ...
      - FRAME "CTA"  326x70  layout=HORIZONTAL  gap=8  pad=16  radius=16
        ...
        - RECTANGLE "image 1"  34x34
          fill: image fill ref=469ed27d0871335a640e9f0b3152a2600f14392f
        - TEXT "Your investigation reveals jenny IS a member of the mafia"  252x30
          text: "Your investigation reveals jenny IS a member of the mafia"
...
| --- | --- | --- | --- |
| `I332:5171;287:3467;185:1610` | House | ON_CLICK | `185:1614` |
| `I332:5171;287:3467;185:1610` | House | transitionNodeID | `185:1614` |
| `I332:5171;325:1579` | tab-hotspot-players | ON_CLICK | `287:3435` |
| `I332:5171;325:1579` | tab-hotspot-players | transitionNodeID | `287:3435` |

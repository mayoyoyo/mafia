...
- size: 390 x 844
- position: x 6000, y 11058

## Layout

- FRAME "Hunter killed"  390x844  radius=16
  fill: #000000
  - FRAME "Container"  358x752  layout=VERTICAL  gap=32
    ...
    - INSTANCE "Membership Card"  357x222  layout=VERTICAL  gap=10  pad=93/166/93/166  radius=16  instance of `77:527` "Role=Default" of set "Membership Card"
      ...
      - FRAME "Frame 1"  28x28
        ...
        - VECTOR "Rectangle 2"  28x28
          ...
          fill: #000000 @ 60%
          stroke: #FFFFFF 2px
    - FRAME "Frame 30"  358x156  layout=VERTICAL  gap=16
      - FRAME "Frame 31"  278x126  layout=VERTICAL
        - RECTANGLE "image 1"  78x78
          fill: image fill ref=44e37d54633fe164707367837d27e0606ce9e149
        - TEXT "The Hunter falls! Waiting for the Hunter…"  278x48
          text: "The Hunter falls!\nWaiting for the Hunter…"
          font: Grandstander / Grandstander-Regular 24px w400 lh 24px
          fill: #FFFFFF
      - TEXT "jenny was the hunter"  146x14
        text: "jenny was the hunter"
...
| --- | --- | --- | --- |
| `I287:3538;287:3467;185:1610` | House | ON_CLICK | `185:1614` |
| `I287:3538;287:3467;185:1610` | House | transitionNodeID | `185:1614` |
| `I287:3538;325:1579` | tab-hotspot-players | ON_CLICK | `287:3435` |
| `I287:3538;325:1579` | tab-hotspot-players | transitionNodeID | `287:3435` |

...
- size: 390 x 844
- position: x 4050, y 7899

## Layout

- FRAME "Various states"  390x844  radius=16
  fill: #000000
  - FRAME "Container"  358x962  layout=VERTICAL  gap=32
    ...
    - FRAME "Players"  358x310  layout=VERTICAL  gap=10  pad=0/16/0/16  radius=16
      ...
      - FRAME "CTA"  326x70  layout=HORIZONTAL  gap=10  pad=16  radius=16
        ...
        stroke: #FFFFFF 2px
        effect: DROP_SHADOW r23.8 offset 0,4 #000000 @ 20%
        - TEXT "jenny - nominated"  129x14
          text: "jenny - nominated"
          font: Grandstander / Grandstander-Regular 14px w400 lh auto
          fill: #FFFFFF
      ...
      - FRAME "CTA"  326x70  layout=HORIZONTAL  gap=10  pad=16  radius=16
        ...
        stroke: #FFFFFF 2px
        effect: DROP_SHADOW r23.8 offset 0,4 #000000 @ 20%
        - FRAME "Frame 29"  133x24  layout=HORIZONTAL  gap=8
          - TEXT "natasha - kill?"  101x14
            text: "natasha - kill?"
            font: Grandstander / Grandstander-Regular 14px w400 lh auto
            fill: #FFFFFF
...
| --- | --- | --- | --- |
| `135:563` | X | ON_CLICK | `130:323` |
| `135:563` | X | transitionNodeID | `130:323` |
| `135:678` | Check | ON_CLICK | `135:763` |
| `135:678` | Check | transitionNodeID | `135:763` |
| `I287:4267;287:3467;185:1610` | House | ON_CLICK | `185:1614` |
| `I287:4267;287:3467;185:1610` | House | transitionNodeID | `185:1614` |
| `I287:4267;325:1579` | tab-hotspot-players | ON_CLICK | `287:3435` |
| `I287:4267;325:1579` | tab-hotspot-players | transitionNodeID | `287:3435` |

...
- size: 390 x 844
- position: x 5350, y 4716

## Layout

- FRAME "Spectating detective"  390x844  radius=16
  fill: #000000
  - FRAME "Container"  358x882  layout=VERTICAL  gap=32
    ...
    - FRAME "Frame 31"  358x286  layout=VERTICAL  gap=16
      - FRAME "Frame 31"  322x110  layout=VERTICAL  gap=8
        - RECTANGLE "image 1"  78x78
          fill: image fill ref=469ed27d0871335a640e9f0b3152a2600f14392f
        - TEXT "Detective is investigating..."  322x24
          text: "Detective is investigating..."
          font: Grandstander / Grandstander-Regular 24px w400 lh 24px
          fill: #FFFFFF
      - TEXT "Choosing who to investigate"  193x14
        text: "Choosing who to investigate"
...
| --- | --- | --- | --- |
| `I287:4321;287:3467;185:1610` | House | ON_CLICK | `185:1614` |
| `I287:4321;287:3467;185:1610` | House | transitionNodeID | `185:1614` |
| `I287:4321;325:1579` | tab-hotspot-players | ON_CLICK | `287:3435` |
| `I287:4321;325:1579` | tab-hotspot-players | transitionNodeID | `287:3435` |

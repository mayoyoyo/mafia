# Spectating vigilante

- id: `254:627`
- type: FRAME
- section: Night Actions
- size: 390 x 844
- position: x 6632, y 4716

## Layout

- FRAME "Spectating vigilante"  390x844  radius=16
  fill: #000000
  - FRAME "Container"  358x1022  layout=VERTICAL  gap=32
    ...
    - FRAME "Frame 31"  358x426  layout=VERTICAL  gap=16
      - FRAME "Frame 31"  347x110  layout=VERTICAL  gap=8
        - RECTANGLE "image 1"  78x78
          fill: image fill ref=f0e46bd39f0411658158f36620061035623685ed
        - TEXT "The Joker has been lynched..."  347x24
          text: "The Joker has been lynched..."
          font: Grandstander / Grandstander-Regular 24px w400 lh 24px
          fill: #FFFFFF
      - TEXT "Joker is choosing their victim"  203x14
        text: "Joker is choosing their victim"
      ...
      - FRAME "Players"  358x270  layout=VERTICAL  gap=10  pad=0/16/0/16  radius=16
        ...
        - FRAME "CTA"  326x60  layout=HORIZONTAL  gap=10  pad=16  radius=16
          ...
          - TEXT "kevin"  37x14
            ...
            font: Grandstander / Grandstander-Regular 14px w400 lh auto
            fill: #FFFFFF
          - TEXT "Saved by doctor"  109x14
            text: "Saved by doctor"
            font: Grandstander / Grandstander-Regular 14px w400 lh auto
            fill: #FFFFFF
        - FRAME "CTA"  326x60  layout=HORIZONTAL  gap=10  pad=16  radius=16
          fill: #232729
          ...
          - TEXT "kevin"  37x14
            ...
            font: Grandstander / Grandstander-Regular 14px w400 lh auto
            fill: #FFFFFF
          - TEXT "Investigated by detective"  173x14
            text: "Investigated by detective"
            font: Grandstander / Grandstander-Regular 14px w400 lh auto
            fill: #FFFFFF
        - FRAME "CTA"  326x60  layout=HORIZONTAL  gap=10  pad=16  radius=16  opacity=60%
          fill: #A0A0A0
          effect: DROP_SHADOW r23.8 offset 0,4 #000000 @ 20%
          - TEXT "Vigilante held their fire"  160x14
            text: "Vigilante held their fire"
            font: Grandstander / Grandstander-Regular 14px w400 lh auto
            fill: #FFFFFF
...
| --- | --- | --- | --- |
| `I287:4294;287:3467;185:1610` | House | ON_CLICK | `185:1614` |
| `I287:4294;287:3467;185:1610` | House | transitionNodeID | `185:1614` |
| `I287:4294;325:1579` | tab-hotspot-players | ON_CLICK | `287:3435` |
| `I287:4294;325:1579` | tab-hotspot-players | transitionNodeID | `287:3435` |

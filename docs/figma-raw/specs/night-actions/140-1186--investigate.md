...
- size: 390 x 844
- position: x 4050, y 10005

## Layout

- FRAME "Investigate"  390x844  radius=16
  fill: #000000
  - FRAME "Container"  358x986  layout=VERTICAL  gap=32
    ...
    - FRAME "Players"  358x310  layout=VERTICAL  gap=10  pad=0/16/0/16  radius=16
      ...
      - FRAME "CTA"  326x70  layout=HORIZONTAL  gap=10  pad=16  radius=16
        ...
        stroke: #FFFFFF 2px
        effect: DROP_SHADOW r23.8 offset 0,4 #000000 @ 20%
        - TEXT "jenny - investigate?"  139x14
          text: "jenny - investigate?"
          font: Grandstander / Grandstander-Regular 14px w400 lh auto
          fill: #FFFFFF
...
| --- | --- | --- | --- |
| `140:1240` | Check | ON_CLICK | `140:1261` |
| `140:1240` | Check | transitionNodeID | `140:1261` |
| `140:1242` | X | ON_CLICK | `130:625` |
| `140:1242` | X | transitionNodeID | `130:625` |
| `I287:3565;287:3467;185:1610` | House | ON_CLICK | `185:1614` |
| `I287:3565;287:3467;185:1610` | House | transitionNodeID | `185:1614` |
| `I287:3565;325:1579` | tab-hotspot-players | ON_CLICK | `287:3435` |
| `I287:3565;325:1579` | tab-hotspot-players | transitionNodeID | `287:3435` |

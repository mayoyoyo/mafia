...
- size: 390 x 844
- position: x 6000, y 4716

## Layout

- FRAME "Spectating vigilante"  390x844  radius=16
  fill: #000000
  - FRAME "Container"  358x952  layout=VERTICAL  gap=32
    ...
    - FRAME "Frame 31"  358x356  layout=VERTICAL  gap=16
      - FRAME "Frame 31"  295x110  layout=VERTICAL  gap=8
        - RECTANGLE "image 1"  78x78
          fill: image fill ref=4cc1c61e57c046fa217093798af4da32356c1422
        - TEXT "Vigilante is taking aim..."  295x24
          text: "Vigilante is taking aim..."
          font: Grandstander / Grandstander-Regular 24px w400 lh 24px
          fill: #FFFFFF
      - TEXT "Deciding whether to shoot"  179x14
        text: "Deciding whether to shoot"
        font: Grandstander / Grandstander-Regular 14px w400 lh auto
        fill: #FFFFFF
      - FRAME "Players"  358x200  layout=VERTICAL  gap=10  pad=0/16/0/16  radius=16
        effect: DROP_SHADOW r23.8 offset 0,4 #000000 @ 20%
...
| --- | --- | --- | --- |
| `I287:4078;287:3467;185:1610` | House | ON_CLICK | `185:1614` |
| `I287:4078;287:3467;185:1610` | House | transitionNodeID | `185:1614` |
| `I287:4078;325:1579` | tab-hotspot-players | ON_CLICK | `287:3435` |
| `I287:4078;325:1579` | tab-hotspot-players | transitionNodeID | `287:3435` |

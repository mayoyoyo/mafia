...
- size: 390 x 844
- position: x 4700, y 4716

## Layout

- FRAME "Spectating doctor"  390x844  radius=16
  fill: #000000
  - FRAME "Container"  358x812  layout=VERTICAL  gap=32
    ...
    - FRAME "Frame 31"  358x216  layout=VERTICAL  gap=16
      - FRAME "Frame 31"  278x110  layout=VERTICAL  gap=8
        - RECTANGLE "image 1"  78x78
          fill: image fill ref=223f4adca0b911c1335b652cd6192fa357ebc220
        - TEXT "Doctor is saving a life..."  278x24
          text: "Doctor is saving a life..."
          font: Grandstander / Grandstander-Regular 24px w400 lh 24px
          fill: #FFFFFF
      - TEXT "Choosing who to save"  146x14
        text: "Choosing who to save"
        font: Grandstander / Grandstander-Regular 14px w400 lh auto
        fill: #FFFFFF
      - FRAME "Players"  358x60  layout=VERTICAL  gap=10  pad=0/16/0/16  radius=16
        effect: DROP_SHADOW r23.8 offset 0,4 #000000 @ 20%
...
| --- | --- | --- | --- |
| `I287:3673;287:3467;185:1610` | House | ON_CLICK | `185:1614` |
| `I287:3673;287:3467;185:1610` | House | transitionNodeID | `185:1614` |
| `I287:3673;325:1579` | tab-hotspot-players | ON_CLICK | `287:3435` |
| `I287:3673;325:1579` | tab-hotspot-players | transitionNodeID | `287:3435` |

...
(function () {
  ...
  var MAGNIFIER_ART = [
    [_,_,_,"#dfe4ee","#dfe4ee","#dfe4ee",_,_,_,_],
    [_,_,"#dfe4ee","#ffffff","#9fc1e3","#9fc1e3","#dfe4ee",_,_,_],
    [_,"#dfe4ee","#ffffff","#9fc1e3","#9fc1e3","#9fc1e3","#79a0c8","#dfe4ee",_,_],
    [_,"#dfe4ee","#9fc1e3","#9fc1e3","#9fc1e3","#79a0c8","#79a0c8","#dfe4ee",_,_],
    [_,_,"#dfe4ee","#9fc1e3","#79a0c8","#79a0c8","#dfe4ee",_,_,_],
    [_,_,_,"#dfe4ee","#dfe4ee","#dfe4ee",_,_,_,_],
